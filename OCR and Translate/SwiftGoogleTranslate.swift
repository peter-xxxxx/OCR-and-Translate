...
public class SwiftGoogleTranslate: BaseTranslate {
	
	/// Shared instance.
    public override class var shared: SwiftGoogleTranslate {
        return SwiftGoogleTranslate()
    }
	...
	*/
    public override func start(with apiKey: String) {
		self.apiKey = apiKey
	}
